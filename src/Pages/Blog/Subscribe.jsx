...
const Subscribe = () => {
  return (
    <section className="subscribe bg-gradient-to-r from-red-700/80 to-blue-700/80 mt-12 rounded-lg py-10 px-4 flex flex-col items-center gap-3 relative overflow-hidden">
